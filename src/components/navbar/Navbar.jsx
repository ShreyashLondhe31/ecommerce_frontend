  ...
  useEffect(() => {
    const delayDebounceFn = setTimeout(() => {
      if (searchQuery.trim().length > 0) {
        setIsSearching(true);
        axios
          .get(`${API_BASE_URL}products/?search=${searchQuery}`)
          .then((res) => {
      ...
      <nav className="w-full bg-amber-200 fixed top-0 left-0 z-50 shadow-sm">
        <div className="flex items-center justify-between h-16 md:h-[68px] px-4 md:px-6 lg:px-8">
          ...
          <Link to="/" className="flex items-center gap-3 flex-shrink-0">
            ...
            <div className="hidden xl:flex flex-col leading-tight">
              ...
              <span className="text-xs text-amber-800">
                Quality Tools & Hardware Since 1989
              </span>
            </div>
          </Link>
                              ...
                              <div key={idx} className="space-y-1">
                                {column.map((category) => (
                                  ...
                                  >
                                    ...
                                    <FaChevronRight
                                      size={10}
                                      className="opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 text-amber-500 transition-all duration-200"
                                    />
                                  </Link>
                                ))}
                              </div>
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <Link
              to="/cart"
              className="relative p-2 hover:bg-amber-300 rounded-full transition-colors"
            ...
            {isLoggedIn ? (
              <button
                ...
                className="hidden sm:block ml-1 p-2 hover:bg-amber-300 rounded-full transition-colors"
              >
            ...
            <button
              className="md:hidden p-2 hover:bg-amber-300 rounded-lg transition-colors"
