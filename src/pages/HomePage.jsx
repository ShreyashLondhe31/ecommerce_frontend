  ...
  return (
    <div className="main min-h-screen w-full">
      ...
      <div className="hero-section w-full px-7 py-10">
        <div className="relative w-full">
          ...
          <div className="overflow-hidden">
            ...
            >
              {/* 3. Map over the slidesToRender array */}
              {slidesToRender.map((slide, index) => (
                <div key={slide.id + "-" + index} className="min-w-full">
                  {/* Your slide content now comes from the 'slide' object */}
      ...
      <div className="w-full mt-7">
        <marquee
          className="text-3xl font-bold bg-amber-200 flex justify-center items-center"
          scrollamount="20"
          height="70px"
        >
          TCC TCC
      ...
      <div className="product-categories h-full w-full flex flex-col justify-center items-center mt-7">
        ...
        <div className="category-container flex flex-wrap justify-center items-center mt-5">
          {productCategories.map((category, idx) => {
            // 2. Create a URL-friendly slug from the category name
            ...
            return (
              ...
              <Link
                ...
                key={idx}
                className="container-card h-60 w-60 flex flex-col justify-center items-center border-2 border-gray-200 rounded-2xl shadow-lg m-5 p-5 transform hover:scale-105 transition-transform duration-300"
              >
                <img
      ...
      <div className="h-full w-full bg-amber-200 flex flex-col justify-center items-center mt-7 py-7">
        <h1 className="text-3xl font-semibold mb-6">BestSeller</h1>
        <div className="h-2 w-full border-t-2"></div>
      ...
      <div className="h-full w-full bg-amber-200 flex justify-around items-center mt-7 py-7">
        ...
        <div className="h-[200px] w-[300px] policies border-2 border-gray-200 rounded-2xl shadow-lg p-5 flex flex-col justify-center items-center">
          <h1 className="text-3xl font-semibold mb-4">Policies</h1>
          <ul className="text-lg">
            <li>Policy 1</li>
            <li>Policy 2</li>
            <li>Policy 3</li>
